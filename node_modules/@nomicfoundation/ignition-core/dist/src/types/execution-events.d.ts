...
export type ExecutionEventListener = {
    [eventType in ExecutionEventType as SnakeToCamelCase<eventType>]: (event: ExecutionEventTypeMap[eventType]) => Promise<void>;
};

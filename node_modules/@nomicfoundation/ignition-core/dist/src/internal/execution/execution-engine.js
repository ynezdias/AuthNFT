...
export class ExecutionEngine {
    ...
    _maxRetries;
    _retryInterval;
    constructor(_deploymentLoader, _artifactResolver, _executionStrategy, _jsonRpcClient, _executionEventListener, _requiredConfirmations, _millisecondBeforeBumpingFees, _maxFeeBumps, _blockPollingInterval, _disableFeeBumping, _maxRetries, _retryInterval) {
     ...
     */
    async _emitBeginNextBatchEvent() {

...
export class FutureProcessor {
    ...
    _maxRetries;
    _retryInterval;
    constructor(_deploymentLoader, _artifactResolver, _executionStrategy, _jsonRpcClient, _transactionTrackingTimer, _nonceManager, _requiredConfirmations, _millisecondBeforeBumpingFees, _maxFeeBumps, _accounts, _deploymentParameters, _defaultSender, _disableFeeBumping, _maxRetries, _retryInterval) {

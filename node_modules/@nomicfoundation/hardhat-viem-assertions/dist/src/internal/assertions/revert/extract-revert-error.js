 ...
 */
export function extractRevertError(error) {
    ensureError(error);
    let dataReason;
    let current = error;
    let message = "";
    ...
    assertHardhatInvariant(dataReason !== undefined, `No revert data found on error.\nError name: "${error.name}", message: ${error.message}`);
    return {
        name: error.name,
        message,
        data: dataReason,
...
//# sourceMappingURL=extract-revert-error.js.map
...
const hardhatKeystorePlugin = {
    id: PLUGIN_ID,
    hookHandlers: {
        config: () => import("./internal/hook-handlers/config.js"),
        configurationVariables: () => import("./internal/hook-handlers/configuration-variables.js"),
    },
    tasks: [
        emptyTask("keystore", "Store keys in an encrypted storage").build(),
        task(["keystore", "set"], "Set a new value in the keystore associated with the specified key")
            ...
            .addFlag({
            name: "dev",
            description: "Use the development keystore instead of the production one",
        })
        ...
        task(["keystore", "delete"], "Delete a key from the keystore")
            ...
            .addFlag({
            name: "force",
            description: "Force to not throw an error if the key does not exist during deletion.",
        })
        ...
        task(["keystore", "path"], "Display the path where the keystore is stored")
            ...
            .build(),
        task(["keystore", "change-password"], "Change the password for the keystore")
            .addFlag({
            name: "dev",
            description: "Use the development keystore instead of the production one",
        })

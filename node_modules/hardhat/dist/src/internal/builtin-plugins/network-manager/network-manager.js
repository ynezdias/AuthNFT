...
export class NetworkManagerImplementation {
    ...
    async #initializeNetworkConnection(networkName, chainType, networkConfigOverride) {
        ...
        const resolvedNetworkConfig = await this.#resolveNetworkConfig(resolvedNetworkName, networkConfigOverride);
        /* eslint-disable-next-line @typescript-eslint/consistent-type-assertions
     ...
     *   plugins
     */
    async #resolveNetworkConfig(resolvedNetworkName, networkConfigOverride) {
        ...
        const configResolutionResult = await resolveUserConfigToHardhatConfig(newConfig, this.#hookManager, this.#projectRoot, this.#userProvidedConfigPath, resolvedPlugins);
